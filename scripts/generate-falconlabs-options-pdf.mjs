...
const OUTPUT_PATH = path.join(REPO_ROOT, 'clients/falconlabs/falcon-labs-engagement-options.pdf');
const PASSWORD = 'FLPROPOSAL';
const SERVE_PORT = 47822;
...
const server = http.createServer((req, res) => {
    ...
    if (urlPath === '/falcon-options' || urlPath === '/falcon-options/') {
        urlPath = '/clients/falconlabs/proposal-options.html';
...
const PROPOSAL_URL = `http://localhost:${SERVE_PORT}/falcon-options`;
