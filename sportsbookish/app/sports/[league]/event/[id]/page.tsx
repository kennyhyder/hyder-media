    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto max-w-3xl px-4 py-8">
        <div className="mb-6">
          ...
          <div className="text-[10px] text-neutral-500 mt-2 font-mono">{detail.event.kalshi_event_ticker}</div>
        </div>
        ...
        <Card className="mb-4">
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <span className="text-xs font-normal text-neutral-500">24h history</span>
            </CardTitle>
          </CardHeader>
          <CardContent className="p-0 divide-y divide-border/40">
            ...
            {detail.markets.length === 0 && (
              <div className="p-8 text-center text-neutral-500">No quotes ingested yet. Check back in a minute.</div>
            )}
          </CardContent>
        </Card>
