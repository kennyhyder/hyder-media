...
export default async function sitemap(): Promise<Sm> {
  ...
  urls.push(
    ...
    { url: `${SITE_URL}/research`,           lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    { url: `${SITE_URL}/research/why-mid-game-kalshi-lines-lag`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/research/how-sportsbooks-reprice-without-news`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/research/volume-concentration-event-contract-ladders`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/clv-leaderboard`,    lastModified: now, changeFrequency: "daily",   priority: 0.85 },
