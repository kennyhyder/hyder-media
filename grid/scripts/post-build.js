...
/**
 * Post-build script for GridScout
 * 1. Injects sessionStorage auth check into all generated HTML pages
 * 2. Moves build output from out/ to parent directory (grid/)
 * Same pattern as SolarTrack and AG2020 dashboards
 */
...
function injectAuth(filePath) {
  ...
  if (html.includes("<head>") && !html.includes("gridscout_auth")) {
...
console.log("GridScout post-build: Injecting auth checks...");
