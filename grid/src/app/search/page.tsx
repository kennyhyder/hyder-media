      ...
      {showMap && (
        <div className="mb-6">
          ...
          <p className="text-xs text-gray-400 mt-1">
            Showing up to 500 lines matching current filters. Purple = upgrade candidates (50-100 MW).
          </p>
        </div>
      )}
              ...
              {loading ? (
                ...
                lines.map((line) => (
                  ...
                  >
                    ...
                    <td className="py-2.5 px-3 text-gray-600 max-w-56 truncate" title={`${line.sub_1 || "?"} - ${line.sub_2 || "?"}`}>
