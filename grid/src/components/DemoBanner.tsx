...
export default function DemoBanner({ limits }: { limits?: DemoLimits | null }) {
  ...
  return (
    ...
    >
      <svg
        style={{ width: "16px", height: "16px", flexShrink: 0, color: "#7c3aed", marginTop: "1px" }}
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
      ...
      <div>
        <div>
          <strong>Demo</strong> &mdash; Limited preview. Export &amp; API docs disabled.{" "}
          <a href="mailto:kenny@hyder.me?subject=GridScout Full Access Request" style={{ textDecoration: "underline", fontWeight: 600 }}>
