/**
 * Google Ads - Vita Brevis Search Terms
 * GET /api/vita-brevis/google-search-terms?days=30&limit=50
 */
...
export default async function handler(req, res) {
    ...
    try {
        ...
        for (const row of (data.results || [])) {
            ...
            if (!byTerm[term]) {
                byTerm[term] = {
                    searchTerm: term, status: stv.status || '', sources: new Set(),
        ...
        const terms = Object.values(byTerm).map(t => ({
            searchTerm: t.searchTerm, status: t.status, sources: [...t.sources],
            impressions: t.impressions, clicks: t.clicks, spend: t.spend,
