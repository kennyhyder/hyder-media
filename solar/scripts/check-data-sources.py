...
DATA_SOURCES = [
    ...
    # ---- NEW SOURCES (Feb 2026) ----
    {
        ...
        "description": "Solar on brownfields, landfills, Superfund sites",
        "url": "https://www.epa.gov/re-powering/re-powering-tracking-matrix",
        "script": "ingest-epa-repowering.py",
        "run_cmd": "python3 -u scripts/ingest-epa-repowering.py",
        "format": "Excel",
        "update_frequency": "quarterly",
        "expected_min_records": 500,
        "data_dir": "epa_repowering",
        "prefix": "epa_repower_",
        "notes": "548 solar projects. 100% owner + developer + capacity coverage.",
    },
    {
        "name": "nrel_community",
        "label": "NREL Community Solar Database",
        "description": "NREL Sharing the Sun community solar projects",
        "url": "https://data.nrel.gov/submissions/216",
        "script": "ingest-nrel-community.py",
        "run_cmd": "python3 -u scripts/ingest-nrel-community.py",
        "format": "Excel",
        "update_frequency": "annual",
        "expected_min_records": 3500,
        "data_dir": "nrel_community_solar",
        "prefix": "nrel_cs_",
        "notes": "3,938 community solar projects. Developer (86%), utility (100%).",
    },
    {
        "name": "municipal_permits",
        "label": "Municipal Permit Portals",
        "description": "Solar permits from 23 US city open data portals",
        "url": None,
        "script": "ingest-permits.py",
        "run_cmd": "python3 -u scripts/ingest-permits.py",
        "format": "Socrata/OpenDataSoft APIs",
        "update_frequency": "monthly",
        "expected_min_records": 80000,
        "data_dir": None,
        "prefix": "permit_",
        "notes": "126,731 records from 23 cities. Tier 1-4 portals. Installer + address data.",
    },
    {
        "name": "pjm_gats",
        "label": "PJM-GATS REC Tracking",
        "description": "PJM Generation Attribute Tracking System",
        "url": "https://gats.pjm-eis.com",
        "script": "enrich-pjm-gats.py",
        "run_cmd": "python3 -u scripts/enrich-pjm-gats.py",
        "format": "Excel (manual export)",
        "update_frequency": "quarterly",
        "expected_min_records": None,
        "data_dir": "pjm_gats",
        "prefix": None,
        "notes": "582K solar generators in 13+ PJM states. Owner enrichment source.",
        "is_enrichment": True,
    },
    {
        "name": "census_geocoder",
        "label": "Census Batch Geocoder",
        "description": "Census Bureau address-to-coordinate batch geocoding",
        "url": "https://geocoding.census.gov/geocoder/geographies/addressbatch",
        "script": "forward-geocode-census.py",
        "run_cmd": "python3 -u scripts/forward-geocode-census.py",
        "format": "API (batch, 10K/request)",
        "update_frequency": "after_ingestion",
        "expected_min_records": None,
        "data_dir": None,
        "prefix": None,
        "notes": "Free batch geocoder. API currently down (Feb 2026). Script ready.",
        "is_enrichment": True,
    },
]
