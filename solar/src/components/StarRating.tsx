export default function StarRating({
  ...
  const partialWidth = Math.round((rating - fullStars) * 100);
  const emptyStars = 5 - fullStars - (partialWidth > 0 ? 1 : 0);
      ...
      <span className="inline-flex" aria-label={`${rating} out of 5 stars`}>
        ...
        {partialWidth > 0 && (
          <span className="relative w-4 h-4">
            ...
            <span className="absolute overflow-hidden" style={{ width: `${partialWidth}%` }}>
